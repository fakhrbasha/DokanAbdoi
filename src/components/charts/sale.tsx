...
export default function SaleChart({ sales, isLoading }: SaleChartProps): React.JSX.Element {
  ...
  return (
    <Card>
      <CardHeader
        title={<>{isLoading ? <Skeleton variant="text" height={28} width={180} /> : 'Sales Report'}</>}
        action={
          <Tabs
            value={seriesData}
