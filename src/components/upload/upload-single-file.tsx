...
export default function UploadSingleFile({ error, file, sx, onDrop, loading, ...other }: UploadSingleFileProps): React.JSX.Element {
      ...
      >
        ...
        {file && (
          <Box
            component="img"
            alt="file preview"
            src={typeof file === 'string' ? file : (file.preview || file.url)}
            sx={{
              top: 8,
              borderRadius: 1,
              objectFit: 'contain',
