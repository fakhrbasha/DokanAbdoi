...
export default function SubCategoryRow({ isLoading, row, handleClickOpen }: SubCategoryRowProps): React.JSX.Element {
      ...
      <TableCell align="right">
        <Stack direction="row" justifyContent="flex-end">
          {isLoading ? (
            ...
            <>
              <Tooltip title="Edit">
                <IconButton onClick={() => router.push(`/admin/categories/sub-categories/${row?.slug || row?._id || ''}`)}>
                  <MdEdit />
                </IconButton>
              </Tooltip>
